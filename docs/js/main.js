...
/* harmony import */ var _components_accord__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/accord */ "./src/js/components/accord.js");
/* harmony import */ var _components_accord__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_accord__WEBPACK_IMPORTED_MODULE_1__);
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.coachers__slider', {
...
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.testimonials__slider', {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],
  slidesPerView: 1,
  loop: true,
  autoplay: true,
...
const afterForm = () => {};
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.cta__form', rules1, afterForm, ['.form__choose']);
...
const validateForms = function (selector, rules, afterSend) {
  let inputRules = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  if (inputRules) {
    for (let item of inputRules) {
      validation.addRequiredGroup(item);
    }
  }
...
const closeBurger = menu.querySelector('.menu__close');
